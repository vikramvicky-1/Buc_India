...
const About = () => {
  ...
  return (
    ...
    >
      {/* Background Decor */}
      <Box sx={{ position: "absolute", top: 0, right: 0, width: "40%", height: "40%", bgcolor: "radial-gradient(circle, rgba(59, 130, 246, 0.05) 0%, transparent 70%)", zIndex: 0 }} />
      <Box sx={{ position: "absolute", bottom: 0, left: 0, width: "40%", height: "40%", bgcolor: "radial-gradient(circle, rgba(59, 130, 246, 0.05) 0%, transparent 70%)", zIndex: 0 }} />
      ...
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 10 }}>
        ...
        <Box sx={{ textAlign: "center", mb: 10 }}>
          ...
          <Typography variant="h2" sx={{
            ...
            Our <Box component="span" sx={{ color: "primary.main" }}>Mission</Box>
          </Typography>
          <Typography variant="body1" sx={{ color: "text.secondary", maxWidth: 720, mx: "auto", fontSize: { xs: "1.1rem", md: "1.25rem" }, lineHeight: 1.8, fontWeight: 500 }}>
            Founded in 2025, Bikers Unity Calls has grown from a small group of motorcycle enthusiasts
            to a thriving all-India community of riders.
          </Typography>
        </Box>
            ...
            <Grid size={{ xs: 12, md: 6 }} key={index}>
              <Card sx={{
                ...
                "&:hover": {
                  ...
                  borderColor: index % 2 === 0 ? "rgba(59, 130, 246, 0.3)" : "rgba(59, 130, 246, 0.3)",
                }
              }}>
                <CardContent>
                  <Box sx={{
                    ...
                    bgcolor: index % 2 === 0 ? "rgba(59, 130, 246, 0.1)" : "rgba(59, 130, 246, 0.1)",
                    border: '1px solid',
                    borderColor: index % 2 === 0 ? "rgba(59, 130, 246, 0.2)" : "rgba(59, 130, 246, 0.2)",
                  }}>
                    {value.icon}
                  </Box>
                  <Typography variant="h6" sx={{ color: "text.primary", mb: 2, fontWeight: 800 }}>
                    {value.title}
                  </Typography>
                  <Typography variant="body2" sx={{ color: "text.secondary", lineHeight: 1.8, fontSize: '0.9rem' }}>
                    {value.description}
                  </Typography>
                </CardContent>
              </Card>
        ...
        <Box sx={{
          ...
          <Box sx={{ position: "absolute", top: -100, right: -100, width: 300, height: 300, bgcolor: "rgba(59, 130, 246, 0.03)", borderRadius: "full", filter: "blur(50px)" }} />
          ...
          <Grid container spacing={6} alignItems="center">
            <Grid size={{ xs: 12, lg: 7 }}>
              ...
              <Typography variant="body1" sx={{ color: "text.secondary", mb: 5, lineHeight: 1.8, fontSize: '1.1rem' }}>
                Whether you're a seasoned rider or just starting, you'll find a welcoming community here.
                We bring together riders from all corners of India to share the freedom of the road.
              </Typography>
              <Grid container spacing={2}>
                {highlights.map((item, i) => (
                  <Grid size={{ xs: 12, sm: 6 }} key={i}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                      <Box sx={{ width: 8, height: 8, borderRadius: 'full', bgcolor: 'primary.main', boxShadow: '0 0 10px rgba(59, 130, 246, 0.5)' }} />
            ...
            <Grid size={{ xs: 12, lg: 5 }}>
              <Box sx={{ position: 'relative' }}>
                ...
                <Box
                  ...
                  src={joinFamilyImg}
                  alt="Group of bikers"
                  sx={{ width: "100%", borderRadius: 5, position: 'relative', zIndex: 1, border: '1px solid rgba(255,255,255,0.1)' }}
                />
              </Box>
            </Grid>
          </Grid>
